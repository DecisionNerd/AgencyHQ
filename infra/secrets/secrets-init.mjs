 ...
 *   webapp.env           — Trigger webapp process secrets (sourced by entrypoint-webapp.sh)
 *   supervisor.env       — Trigger worker stack container process secrets (sourced by entrypoint-supervisor.sh)
 ...
 *   clickhouse.env       — Clickhouse credentials (sourced by entrypoint-clickhouse.sh)
 *   minio.env            — MinIO credentials (sourced by entrypoint-minio.sh)
 *
...
const webappEnv = [
  "# Trigger webapp secrets — sourced by entrypoint-webapp.sh",
...
const supervisorEnv = [
  ...
  "# Trigger worker stack container secrets — sourced by entrypoint-trigger-worker.sh",
  "# Never commit this file. Generated by secrets-init.",
  `MANAGED_WORKER_SECRET=${managedWorkerSecret}`,
  "",
].join("\n");
...
const clickhouseEnv = [
  "# Clickhouse secrets — sourced by entrypoint-clickhouse.sh",
  "# Never commit this file. Generated by secrets-init.",
  `CLICKHOUSE_PASSWORD=${clickhousePassword}`,
  "",
].join("\n");
...
const minioEnv = [
  "# MinIO secrets — sourced by entrypoint-minio.sh",
  "# Never commit this file. Generated by secrets-init.",
